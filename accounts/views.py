...
from django.contrib.auth.views import PasswordResetCompleteView, PasswordResetView,PasswordResetConfirmView, PasswordResetDoneView# Create your views here.
