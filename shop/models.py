...
class ProductAttribute(models.Model):
    ...
    product_type = models.ForeignKey(
        ProductType, on_delete=models.CASCADE, related_name="attr")
...
class Product(models.Model):
    ...
    type = models.ForeignKey(
        ProductType, on_delete=models.CASCADE, related_name='type')
...
class ProductAttributeValue(models.Model):
    product = models.ForeignKey(
        Product, on_delete=models.CASCADE, related_name='attr_value')
    value = models.CharField(max_length=200)
    attributes = models.ForeignKey(
        ProductAttribute, on_delete=models.CASCADE, related_name='value')
